          ...
          <div className="w-full flex items-center justify-start flex-col gap-3 lg:hover:scale-105 cursor-pointer transition-all duration-300 border-solid border-main border-2 rounded p-5 bg-main bg-opacity-20">
            ...
            <div className="w-full flex items-start justify-center flex-col gap-2">
              <p className="w-full text-white font-medium text-base text-center">
                We are a community of peers helping and motivating each other to
                exercise, lose weight, eat healthier, and live more vibrant,
                confident lives. We literally want to change the world.
              </p>
              <p className="w-full text-white font-medium text-base text-center ">
          ...
          <div className="w-full flex items-center justify-start flex-col gap-3 lg:hover:scale-105 cursor-pointer transition-all duration-300 border-solid border-main border-2 rounded p-5 bg-main bg-opacity-20">
            ...
            <div className="w-full flex items-start justify-center flex-col gap-2">
              ...
              <p className="w-full text-white font-medium text-base text-center ">
                ...
                unique piece of art. Play our healthy-living RPG game, create a
                character that tells your story, and add NFTs to customize your
                digital life.
              </p>
            </div>
