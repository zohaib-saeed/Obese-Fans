            ...
            <div className="w-full flex items-start justify-center flex-col gap-3 lg:gap-4">
              <Fade direction="up" triggerOnce>
                <p className="text-white font-medium text-base lg:text-lg text-center md:text-left">
                  Start your journey here with the help of like-minded people
                  and professionals; or even become a foundation member of
                  ObeseFans and inspire others with your story.
                </p>
              </Fade>
              ...
              <Fade direction="up" triggerOnce>
                <p className="text-white font-medium text-base lg:text-lg text-center md:text-left">
                  ...
                  $CLRS tokens before they are sold out. This purchase allows
                  you to obtain our tokens at a discounted price of $0.0010 and
                  also provides you with &quot;access to&quot; multiple other
